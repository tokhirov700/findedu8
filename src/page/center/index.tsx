...
const CenterPage = () => {
  ...
  return (
    ...
    <div>
        ...
        {   
          <div id="center" data-aos="fade-up" className="flex rounded-[12px] overflow-hidden mb-[50px]">
            <div className="w-full max-w-[550px] relative">
              ...
              <span
                className="absolute top-[15px] right-[15px] text-[22px] w-[50px] h-[50px] z-50 flex justify-center items-center bg-white rounded-[50%]"
              >
                <HeartOutlined />
              </span>
            </div>
